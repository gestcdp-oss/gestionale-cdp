...
/**
 * Avvisi a comparsa: ogni operazione (salva, importa, esporta, cancella…) dice
 * com'è andata con un riquadro in basso a destra, così l'esito si vede sempre
 * anche quando il pulsante premuto sta in fondo alla pagina.
 */
